                ...
                <div class="wrapper">
                    ...
                    <div class="inner">                      
                        ...
                        <form method="get" id="searchformtop" action="search.php">                             
                            <input type="text" value="Buscar" onfocus="if (this.value == 'search') {this.value = '';}" onblur="if (this.value == '') {this.value = 'search';}" name="s" id="s" />          
                        </form>                      
...
<!--                     <ul>
                ...
                <li><a href="<?php echo base_url();?>index.php/sgnController">Registro</a></li>
                <li><a href="<?php echo base_url();?>index.php/acervezaController">Alta Cerveza</a></li>
            ...
            <div id="random-article">
                ...
                <a title="Random Article" href="<?php echo base_url();?>index.php/welcome/review"><img alt="Random Article" src="<?php echo base_url();?>/images/random-article.png" /></a>
        ...
        <?php include("dont-miss.php"); //get the dont miss bar ?>
        
        <div id="main-wrapper">
        
        
        
            <?php include("latest.php"); //get the latest slider ?>