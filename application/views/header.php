    ...
    <div id="search">
        ...
        <div class="wrapper">
            ...
            <div class="inner">                      
                ...
                <form method="get" id="searchformtop" action="<?php echo base_url()."bb/buscar" ?>">
                    <table>
                        <tr>
                            <td>
                                <select form="searchformtop" name="tipo">
                            ...
                            <td>
                                <input required type="text" value="Buscar" onfocus="if (this.value == 'Buscar') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Buscar';}" name="palabra" id="s" />
                            </td>
                      </tr>
                  </table>     
              </form>                       
    ...
    <div id="logo-bar-wrapper">  <!--begin the main header logo area-->
        ...
        <div id="logo-bar">
            ...
            <div id="logo-wrapper">
                ...
                <div class="subtitle">
                    <!-- http://fonts.googleapis.com/css?family=Sonsie+One&text=BeerBoss&effect=3d -->
                </div>
